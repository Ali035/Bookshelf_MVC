...
function onSuccess(result) {
    ...
    const gridOptions = {
        ...
        columnDefs: [
            { field: "title", flex: 1.2, filter: true, floatingFilter: true, minWidth: 200 },
...
function createActionbuttons({ value }) {
    ...
    gui.innerHTML = `
        <a href="/Product/Edit/${value}" class="btn btn-primary mx-2">
            <i class="bi bi-pencil-square"></i> Edit
        </a>
        <a href="/Product/Delete/${value}" class="btn btn-danger mx-2">
